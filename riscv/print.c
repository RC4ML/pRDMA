...
void dump_csr(){
	...
	DUMP_CSR(CSR_TRAP);
    DUMP_CSR(CSR_HAS_EVENT);
    DUMP_CSR(CSR_RECEIVED_EVENT_COUNT);
    DUMP_CSR(CSR_PROCESSED_EVENT_COUNT);

	PRINT_CSR(CSR_PRINT_ADDR);
	PRINT_CSR(CSR_PRINT_STRING_NUM);
	PRINT_CSR(CSR_PRINT_STRING_LEN);
	PRINT_CSR(CSR_TRAP);
    PRINT_CSR(CSR_HAS_EVENT);
    PRINT_CSR(CSR_RECEIVED_EVENT_COUNT);
    PRINT_CSR(CSR_PROCESSED_EVENT_COUNT);
}